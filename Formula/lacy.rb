class Lacy < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/timothebot/lacy/releases/download/v0.7.1/lacy-0.7.1-x86_64-apple-darwin.tar.gz"
      sha256 "3bc1380242615358b9eb4eb17029b81d9272dbf6c1ebdcc785434a5a13e1e9db"
    end

    on_arm do
      url "https://github.com/timothebot/lacy/releases/download/v0.7.1/lacy-0.7.1-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/timothebot/lacy/releases/download/v0.7.1/lacy-0.7.1-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "9d23f9f72b4c556a964a47c0178340c0ea881e7c0ffd3e013cbfa6f566279359"
    end

    on_arm do
      url "https://github.com/timothebot/lacy/releases/download/v0.7.1/lacy-0.7.1-aarch64-unknown-linux-gnu.tar.gz"
